...
# Run and validate the center-aligned five-seed R3 refresh with fashr 0.1.43.
...
EXPECTED_R3_DRIVER_SHA256 <-
  "765f6e673bcef9239601c61ee5317eaf5b90265ffbd569ae932374e67d24bfe0"
EXPECTED_SIMULATION_FUNCTIONS_SHA256 <-
  "3662ef6ca28d712cef8434e24fc677f6f6efdd0bb9c88198978c6b799763a307"
...
WRAPPER_CORE_PATH <- require_file(
  Sys.getenv(
    ...
    unset = file.path(WORKSPACE_DIR, "scripts", "13_r3_fashr0143.R")
  ),
  "R3 wrapper core"
)
...
manifest <- list(
  schema_version = "r3-fashr0143-manifest-v3",
  result_id = RESULT_ID,
