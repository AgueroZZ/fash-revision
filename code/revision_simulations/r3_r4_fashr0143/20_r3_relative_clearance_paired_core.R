...
# Run and validate the scale-adaptive, paired-posterior R3 refresh.
...
EXPECTED_R3_DRIVER_SHA256 <-
  "6576564964bbcda0ece53ed6b337facc47c8bec69aba25853bb0f38bebc490b3"
EXPECTED_SIMULATION_FUNCTIONS_SHA256 <-
  "7806d719315caa70bfd5e4dfe239d646d920a8679deac9864a3b715da2572433"
...
R3_DRIVER_PATH <- require_file(
  Sys.getenv(
    ...
    unset = file.path(
      WORKSPACE_DIR,
      "code", "revision_simulations", "r3_relative_clearance_paired_fashr0143",
      "r3_relative_clearance_paired_driver.R"
    )
  ),
  "R3 driver"
)
SIMULATION_FUNCTIONS_PATH <- require_file(
  Sys.getenv(
    ...
    unset = file.path(
      WORKSPACE_DIR,
      "code", "revision_simulations", "r3_relative_clearance_paired_fashr0143",
      "r3_relative_clearance_paired_simulation_functions.R"
    )
  ),
...
WRAPPER_CORE_PATH <- require_file(
  Sys.getenv(
    ...
    unset = file.path(
      WORKSPACE_DIR,
      "scripts", "20_r3_relative_clearance_paired_core.R"
    )
  ),
  "R3 wrapper core"
)
...
log_message(
  paste(
    "Raised-cosine centers: early 0.5-1.5; middle 4.5-10.5; late 13.5-14.5.",
...
manifest <- list(
  schema_version = "r3-fashr0143-manifest-v6-relative-location-paired",
  result_id = RESULT_ID,
