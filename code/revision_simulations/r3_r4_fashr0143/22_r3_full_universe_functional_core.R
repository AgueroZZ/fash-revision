...
# Run and validate the full-universe R3 functional calibration refresh. The
# underlying driver remains resumable at the replicate level;
...
WRAPPER_CORE_PATH <- require_file(
  Sys.getenv(
    ...
    unset = file.path(
      WORKSPACE_DIR,
      "scripts", "22_r3_full_universe_functional_core.R"
    )
  ),
  "R3 wrapper core"
)
...
manifest <- list(
  schema_version = "r3-fashr0143-manifest-v8-full-universe-functional",
  result_id = RESULT_ID,
