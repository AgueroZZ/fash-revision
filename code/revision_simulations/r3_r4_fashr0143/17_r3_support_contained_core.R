...
# Run and validate the support-contained five-seed R3 refresh with fashr 0.1.43.
...
EXPECTED_R3_DRIVER_SHA256 <-
  "7f5461d888aac8faaf3425e9ed9861aa5a1e1eaac84c3c48bee42af42c159246"
EXPECTED_SIMULATION_FUNCTIONS_SHA256 <-
  "f928897aef52c7a6bafa521dca00a732d5cddb391f0f20688646663f39c535b9"
...
WRAPPER_CORE_PATH <- require_file(
  Sys.getenv(
    ...
    unset = file.path(
      WORKSPACE_DIR,
      "scripts", "17_r3_support_contained_core.R"
    )
  ),
  "R3 wrapper core"
)
...
manifest <- list(
  schema_version = "r3-fashr0143-manifest-v4",
  result_id = RESULT_ID,
