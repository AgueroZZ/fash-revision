...
# Run and validate the formal five-seed R3 refresh with fashr 0.1.43.
...
EXPECTED_R3_DRIVER_SHA256 <-
  "c3843168b74746856ec6f3c4584709c35f2db52e32cb8e7cfcb61ec660a19f74"
EXPECTED_SIMULATION_FUNCTIONS_SHA256 <-
  "b395fc78ee8bdca5daf9befe450c011ea12f52d399e522799d20f888e3f975cf"
...
manifest <- list(
  schema_version = "r3-fashr0143-manifest-v2",
  result_id = RESULT_ID,
