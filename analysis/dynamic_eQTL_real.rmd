...
```{r}
# # The version using CL-based PCs
...
loaded_fit1_update <- load(file.path(result_dir, "fash_fit1_update.RData"))
stopifnot(
...
All BF-adjusted results below use the retained fit recomputed with `fashr` 0.1.43. The conservative estimate is `r fash_fit1_update$prior_weights$prior_weight[1]`, which is much more realistic.
