...
- *Middle*: eQTLs with strongest effect during days 4-11: $\sup_{4\leq t\leq 11} |\beta(t)| - \sup_{t> 11 | t< 4} |\beta(t)| > 0$.
...
The displayed functionals are continuous-time definitions using suprema; the code below uses maxima on the `0.1`-day evaluation grid as their discrete approximation.
