...
ggsave(filename = paste0("fash_prior_comparison_order2_before.png"),
       plot = g_before,
       width = 8, height = 6)

ggsave(filename = paste0("fash_prior_comparison_order2_after.png"),
       plot = g_after,
       width = 8, height = 6)

ggsave(filename = paste0("fash_prior_comparison_order2_before.pdf"),
       plot = g_before,
       width = 8, height = 6)

ggsave(filename = paste0("fash_prior_comparison_order2_after.pdf"),
       plot = g_after,
       width = 8, height = 6)
```
