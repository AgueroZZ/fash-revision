...
# load(file.path(result_dir, "fash_fit2_all_CL.RData"))
```
...
loaded_fit2_update <- load(file.path(result_dir, "fash_fit2_update.RData"))
stopifnot(
...
All BF-adjusted results below use the retained fit recomputed with `fashr` 0.1.43. The conservative estimate is `r fash_fit2_update$prior_weights$prior_weight[1]`, which is much more conservative.
