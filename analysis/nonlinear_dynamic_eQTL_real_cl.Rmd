...
The retained classification files were recomputed from `fash_fit2_update` using one shared set of 3,000 posterior draws per pair across the four functionals. We first take a look at the significant pairs detected by FASH (order 2), and classify them based on the false sign rate (lfsr):
